                                ...
                                <div class="tickets-container">
                                    <ul class="tickets-list">
                                        <li class="ticket-item">
                                            <div class="row">
                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                    {!! Html::image('images/admin/avatars/adam-jansen.jpg', '', ['class' => 'user-avatar']) !!}
                                        ...
                                        <li class="ticket-item">
                                            <div class="row">
                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                {!! Html::image('images/admin/avatars/divyia.jpg', '', ['class' => 'user-avatar']) !!}
                                        ...
                                        <li class="ticket-item">
                                            <div class="row">
                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                    {!! Html::image('images/admin/avatars/Matt-Cheuvront.jpg', '', ['class' => 'user-avatar']) !!}
                                        ...
                                        <li class="ticket-item">
                                            <div class="row">
                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                    {!! Html::image('images/admin/avatars/Sergey-Azovskiy.jpg', '', ['class' => 'user-avatar']) !!}
                                        ...
                                        <li class="ticket-item">
                                            <div class="row">
                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                    {!! Html::image('images/admin/avatars/John-Smith.jpg', '', ['class' => 'user-avatar']) !!}
